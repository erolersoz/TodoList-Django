...
urlpatterns = [
    ...
    path('category/<slug:category_slug>/',category_view,name='category_view' ),#The slag here comes from the model and then from the views
    path('tag/<slug:tag_slug>/',tag_view,name='tag_view' ),#tag
